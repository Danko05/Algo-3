    ...
    with open(file_path, "r") as file:
        for i, line in enumerate(file):
            ...
            if i == 0:
                ...
                if number1 in tribes and number2 in tribes:
                    tribe = min(tribes[number1], tribes[number2])
                    for key, value in tribes.items():
                        if value == tribes[number1] or value == tribes[number2]:
                            tribes[key] = tribe
                elif number1 in tribes:
